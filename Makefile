...
dev: $(KIND) $(KUBECTL)
	...
	@$(INFO) Installing Provider Dex CRDs
	@$(KUBECTL) apply -R -f package/crds
	@$(INFO) Starting Provider Dex controllers
...
# This target prepares repo for your provider by replacing all "dex"
