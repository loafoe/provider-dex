...
//go:generate go run -tags generate sigs.k8s.io/controller-tools/cmd/controller-gen paths="./..." paths="../internal/..." rbac:roleName=provider-dex-system output:rbac:dir=../package
